...
The app is a way for pet adoption agencies to post their avaiable pets for soon to be pet parents to look at. Once a pet is adopted the pet disappears from the list of pets and one more pet is added to the count of adopted pets on the main page. Adoption agencies sign up for an account which keeps track of all their pets. The agencies list their contact info for pet parents to contact them if they are intrested in a specific pet. Once a pet is adopted the agency can update the pet status as well as anything else they want.
